...
function subcaseAVerificationRequest(
  ...
  return {
    ...
    state: [
      ...
      { kind: "unrelated-mutation-absence", assertion: stateAssertion("d04.a.sentinel", "unrelated-mutation-absence", String(sentinel.path), "Subcase A leaves the sentinel untouched."), local: protectedPaths.local, remote: protectedPaths.remote },
    ],
    convergence: [
