...
Execute real auth revocation/restoration plus disable/uninstall/reinstall/unlink non-destructive behavior.

Required end state:

> Security/lifecycle physical evidence complete.
