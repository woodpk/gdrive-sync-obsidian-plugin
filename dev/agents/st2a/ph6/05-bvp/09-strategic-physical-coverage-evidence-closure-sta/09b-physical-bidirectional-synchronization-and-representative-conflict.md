...
Execute physical create/update/download both directions and representative concurrent conflict.

Required end state:

> Cross-device convergence/conflict evidence complete.
