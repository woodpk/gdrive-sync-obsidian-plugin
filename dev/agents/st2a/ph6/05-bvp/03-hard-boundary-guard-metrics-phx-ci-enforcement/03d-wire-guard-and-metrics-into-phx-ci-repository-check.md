...
Ensure every PHX-CI acceptance executes BVP guard/metrics without adding a BVP verifier framework.

Required end state:

> Repository check invokes guard+metrics; frozen governance established; no task-specific verifier.
