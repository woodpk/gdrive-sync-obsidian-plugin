# 03C — Implement architecture metrics and budget gates
...
Implement deterministic architecture metrics and hard budget evaluation.

Required end state:

> Required metrics/deltas produced; hard budgets fail closed.
