...
Implement the generic architecture guard and deterministic negative cases.

Required end state:

> Guard fails prohibited dependency/bundle/scenario/archive/script/frozen-surface cases and passes compliant baseline.
