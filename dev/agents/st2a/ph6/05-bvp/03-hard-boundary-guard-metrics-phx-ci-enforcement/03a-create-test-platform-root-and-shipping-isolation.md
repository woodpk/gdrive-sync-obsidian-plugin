# 03A — Create test-platform root and shipping isolation
...
Create the minimal test-platform root/build/test skeleton outside src and prove ordinary production build excludes it.

Required end state:

> Separate root exists; production build remains unchanged/exclusive; no runner/simulator.
