...
> Integrated phase6-integration passes PHX-CI; no legacy runtime/UI/bundle identifiers; no replacement platform started.
...
Only after PHX-CI and independent review pass may the supervisor mark BVP-S02 accepted and bind the first child of the next primary stage.
