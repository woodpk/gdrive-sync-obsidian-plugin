# 06A — Initialization and one-sided synchronization scenarios
...
Add declarative coverage for fresh/equal/local-only/remote-only/divergent initialization and ordinary one-sided changes.

Required end state:

> Mapped initialization/ordinary-sync scenarios pass with no core changes.
