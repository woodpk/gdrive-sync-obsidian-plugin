...
| 02A | S02 — Legacy Executable Retirement | EXECUTABLE NEXT | `02-legacy-executable-retirement/02a-retire-harness-only-test-support-surface.md` |
| 02B | S02 — Legacy Executable Retirement | PREPLANNED | `02-legacy-executable-retirement/02b-retire-harness-source-and-production-coupling.md` |
| 02V | S02 — Legacy Executable Retirement | PREPLANNED | `02-legacy-executable-retirement/02v-primary-stage-phx-ci-acceptance.md` |
