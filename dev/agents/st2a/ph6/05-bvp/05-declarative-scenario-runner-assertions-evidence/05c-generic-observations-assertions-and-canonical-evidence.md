...
Implement generic assertion/observation primitives and canonical machine/human evidence with requirement metadata.

Required end state:

> Wrong expectations fail; evidence is deterministic/private/traceable.
