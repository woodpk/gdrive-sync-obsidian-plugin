# 04D — Per-device durable state, deterministic time/order, restart
...
Provide independent device state/identity/cursor/tombstone stores plus deterministic time/order and reconstruction.

Required end state:

> Two device-local authorities survive runtime reconstruction over retained simulated reality.
