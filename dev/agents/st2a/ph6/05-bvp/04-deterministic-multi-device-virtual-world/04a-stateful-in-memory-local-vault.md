# 04A — Stateful in-memory local vault
...
Implement the stateful LocalVaultPort simulation required for deterministic product execution.

Required end state:

> Local observation/read/write/move/trash/listing/path/config behaviors covered; no sync policy in adapter.
