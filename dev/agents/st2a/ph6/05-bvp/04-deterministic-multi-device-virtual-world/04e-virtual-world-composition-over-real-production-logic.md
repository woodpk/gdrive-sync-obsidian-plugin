# 04E — Virtual-world composition over real production logic
...
Compose two logical devices and shared Drive around real production planner/executor/state code.

Required end state:

> Create/upload/download/two-device/move/partial-listing/ambiguous/restart production-path canaries pass.
