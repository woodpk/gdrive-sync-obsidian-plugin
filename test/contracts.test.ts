...
const plan: SynchronizationPlan = { planId, trigger: "manual", operations: [operation], executionDisposition: "safe-auto-eligible", recoveryCheckpointRequired: false, globalExecutionGate: "none" };
