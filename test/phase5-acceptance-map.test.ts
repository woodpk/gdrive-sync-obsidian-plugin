...
export const PHASE5_ACCEPTANCE_EVIDENCE:readonly Phase5AcceptanceEvidence[]=[
 ...
 e(19,"corrupt or missing expected synchronization state enters safe recovery","test/phase5-recovery-auth.test.ts","C2 recovery conflict mutation remains blocked until fresh reconstruction establishes durable authority"),
 e(20,"invalid Changes cursor falls back conservatively to full reconciliation",recovery,"G2 scenario 20 without ReliableRemoteChangePort falls back to safe full reconciliation and commits a fresh cursor"),
