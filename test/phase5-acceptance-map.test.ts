...
export const PHASE5_ACCEPTANCE_EVIDENCE: readonly Phase5AcceptanceEvidence[] = [
  ...
  automated(20, "invalid Changes cursor falls back conservatively to full reconciliation", "test/phase3-changes.test.ts", "invalid change cursor is a conservative recovery signal", "GoogleDriveAdapter cursor signal consumed by ProductSnapshotAssembler conservative full path"),
