...
export const PHASE5_ACCEPTANCE_EVIDENCE:readonly Phase5AcceptanceEvidence[]=[
 ...
 e(30,"cross-instance writer exclusion run lease",recovery,"G2 scenario 30 two real controller runs sharing production lease cannot mutate concurrently"),
 ...
 e(47,"notifications occur only for meaningful conditions",surface,"G2 scenario 47 production surface listener passes only material conditions through notification delivery filter","IntegratedProductController surface delivery through MeaningfulNotificationFilter"),
